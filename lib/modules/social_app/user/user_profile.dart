                  ...
                  children: [
                      ...
                      child: TabBar(
                        ...
                        tabs: [
                          Tab(
                            child: Column(
                              children: [
                                Text('${SocialCubit.get(context).userPosts.length}',style: Theme.of(context).textTheme.headline6!.copyWith(
                          ...
                          Tab(
                            child: Column(
                              children: [
                                Text('${SocialCubit.get(context).userFollowers}',style: Theme.of(context).textTheme.headline6!.copyWith(
                                    fontWeight: FontWeight.bold
                                ),),
                                Text('Followers',
                                  style: Theme.of(context).textTheme.caption!.copyWith(
                          ...
                          Tab(
                            child: Column(
                              children: [
                                Text('${SocialCubit.get(context).userFollowings}',style: Theme.of(context).textTheme.headline6!.copyWith(
                                  fontWeight: FontWeight.bold,
                                ),),
                                Text('Following',
                                  style: Theme.of(context).textTheme.caption!.copyWith(
                    ...
                    if(SocialCubit.get(context).c == 0)
                      Padding(
                        ...
                        child: ConditionalBuilder(
                          condition: SocialCubit.get(context).userPosts.isNotEmpty,
                          builder: (context) => ListView.separated(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) {
                              return buildPost(SocialCubit.get(context).userPosts[index],context,index,);
                            },
                    ...
                    if(SocialCubit.get(context).c == 1)
                      Padding(
                        ...
                        child: ConditionalBuilder(
                          condition: SocialCubit.get(context).userFollower.isNotEmpty,
                          builder: (context) => ListView.separated(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) {
                              return buildUsers(SocialCubit.get(context).userFollower[index],context);
                            },
                            separatorBuilder: (context, index) => SizedBox(height: 10,),
                            itemCount: SocialCubit.get(context).userFollower.length,
                          ),
                    ...
                    if(SocialCubit.get(context).c == 2)
                      Padding(
                        ...
                        child: ConditionalBuilder(
                          condition: SocialCubit.get(context).userFollowing.isNotEmpty,
                          builder: (context) => ListView.separated(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) {
                              ...
                              return buildUsers(SocialCubit.get(context).userFollowing[index],context);
                              // return Container();
                            },
                            separatorBuilder: (context, index) => SizedBox(height: 10,),
                            itemCount: SocialCubit.get(context).userFollowing.length,
                          ),
